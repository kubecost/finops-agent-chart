...
| `cspPricingApiKey.apiKey`                            | The GCP API key value. If this is set, the secret will be created. Leave empty to use an existing secret.                                                                                  | `"AIzaSyDXQPG_MHUEy9neR7stolq6l0ujXmjJlvk"`                                           |
